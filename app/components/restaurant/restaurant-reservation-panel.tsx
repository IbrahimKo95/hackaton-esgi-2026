...
export default function RestaurantReservationPanel({
  ...
  function renderCalendar() {
    return (
      <div className="mt-4 rounded-[24px] border border-black/10 bg-[#fafafa] p-4">
        ...
        <div className="mt-4 grid grid-cols-7 gap-1 text-center text-[11px] font-medium uppercase tracking-[0.18em] text-black/45">
        ...
        <div className="mt-2 grid grid-cols-7 gap-1">
          {calendarDays.map((day, index) => {
            if (!day) {
              return <span key={`empty-${index}`} className="h-11 rounded-2xl" />;
            }
            ...
            return (
              <button
                ...
                className={`h-11 rounded-2xl text-[14px] font-medium transition ${
                  disabled
  ...
  function renderTimeSlots() {
    return (
      <div className="mt-4 rounded-[24px] border border-black/10 bg-[#fafafa] p-4">
        <p className="text-[13px] font-medium text-black/55">{formatDateLabel(selectedDate)}</p>
          ...
          {TIME_SLOTS.map((slot) => {
            ...
            return (
              <button
                ...
                className={`rounded-2xl px-3 py-3 text-[14px] font-medium transition ${
              ...
              <div className="mt-5 flex items-center justify-between gap-3">
                {step !== "date" ? (
                  <button
                    ...
                    className="rounded-full border border-black/10 px-4 py-2.5 text-[14px] font-medium transition hover:bg-black/5"
                  >
                    Retour
                  </button>
                ) : (
